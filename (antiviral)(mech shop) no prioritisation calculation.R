...
for (group in 1:length(risk_group_list)){
  ...
  #calculate age risk split of adult population
  ...
  risk_group_uniform_proportion[[group]] = c(risk_group_name,risk_split$sum[risk_split$risk_group == risk_group_name])
}

#CHECK uniform delivery over time
