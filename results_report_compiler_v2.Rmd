...
Rho initial: `r paste(rho_inital)`
...
Delay from first dose to protection |`r paste(vaccine_coverage_delay_1,'days')` |
Delay from second dose to protection |`r paste(vaccine_coverage_delay_2,'days')` |
***