  ...
  risk_group_labels = unique(incidence_log_tidy$risk_group)  
   ...
   ### PART ONE: sampling raw age distributions -> RR by age  #############################################
    ...
    if (length(risk_group_labels)>1){
      ...
      ###COMEBACK - tidy pop_risk_group_dn and RR_estimate stochastic
      RR_estimate = 2
