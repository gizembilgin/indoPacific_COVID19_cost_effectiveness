...
# queue[[3]]
queue[[3]] = queue[[2]]
queue[[3]]$vax_strategy_description = 'baseline - idealised prioritisation strategy'
queue[[3]]$vax_strategy_toggles$vax_age_strategy = paste(setting,"_plan",sep="")    
# COMEBACK - need greater age group flexibility 0-4,5-18,19-29,30-59,60-69,70+ at least for SLE
# COMEBACK - need greater age group flexibility 0-4,5-18,19-44,45+ at least for PNG


# (C/?) Increased speed of roll-out (queue[[4-5]]) _______________________________________________
queue[[4]] = queue[[2]]
queue[[4]]$vax_strategy_description = 'double speed'
queue[[4]]$vax_strategy_toggles$vax_strategy_roll_out_speed = queue[[4]]$vax_strategy_toggles$vax_strategy_roll_out_speed * 2

queue[[5]] = queue[[2]]
queue[[5]]$vax_strategy_description = 'x5 speed'
queue[[5]]$vax_strategy_toggles$vax_strategy_roll_out_speed = queue[[4]]$vax_strategy_toggles$vax_strategy_roll_out_speed * 5


# (D/?) Include children 5-19 (queue[[6]]) _______________________________________________________
#COMEBACK - should be 5-17
queue[[6]] = queue[[2]]
queue[[6]]$vax_strategy_description = 'expand to children!'
queue[[6]]$vax_strategy_toggles$vax_age_strategy = "uniform"  
