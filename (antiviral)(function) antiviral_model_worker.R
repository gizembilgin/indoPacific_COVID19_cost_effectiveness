antiviral_model_worker <- function(
  ...
  for (run_number in 1:nrow(manager_scenario_dataframe)){
    ...
    ### LOAD VAX SCENARIO ########################################################
    toggle_antiviral_target        = manager_scenario_dataframe$antiviral_target_group[run_number]
    ...
    for (antiviral_run_number in 1:length(local_LIST_antiviral_start_date)){
      toggle_antiviral_start_date = local_LIST_antiviral_start_date[[antiviral_run_number]]
