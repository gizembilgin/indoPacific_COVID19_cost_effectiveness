# This function calculates the QALYs, deaths, and hospital admissions averted 
# by setting, booster_vax_scenario, intervention, and intervention_target_group
...
estimate_outcomes_averted <- function(
  ...
  #add back hosp and death outcomes
